...
#[test]
fn mtproto_invoke_with_layer_keeps_generic_tl_layout_exact() -> TestResult {
    let bytes = [
        0x0d, 0x0d, 0x9b, 0xda, // invokeWithLayer
        0xc8, 0x00, 0x00, 0x00, // layer 200
        0x6b, 0x18, 0xf9, 0xc4, // help.getConfig
    ];
    let view = InvokeWithLayer::<HelpGetConfig>::view(bytes)?;
    assert_eq!(view.constructor(), 0xda9b_0d0d);
