...
pub(super) struct Input<'a> {
    ...
    pub(super) direct_view_request: &'a Ident,
    ...
    pub(super) preparation_body: &'a TokenStream,
    pub(super) prepare_field_parameters: &'a [TokenStream],
    pub(super) prepare_destructure: &'a [TokenStream],
